...
Se define cupones como arreglo de cadenas de texto donde se almacenarán los cupones de descuento para después validar el ingresado por el usuario.
...
4. Se aplica descuento por cantidad multiplicando el costo sumado hasta ahora por el descuento por cantidad.
